...
(function () {
  ...
  var onBigPictureOpen = function (evt) {
    ...
    bigPictureImage.src = target.querySelector('img').src;
    bigPictureImage.alt = target.querySelector('img').alt;
    bigPictureDescription.textContent = target.querySelector('img').alt;
    likesCount.textContent = target.querySelector('.picture__likes').textContent;
